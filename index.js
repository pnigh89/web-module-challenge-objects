...
const burger = {name: "Burger", price: 18, category: "Lunch",
      discount: function(customerType) {
          if (customerType === "teacher" | "student"){
...
function createMenuItem(name, cost, category){
    ...
    /* Code here */
      ...
      console.log(createMenuItem("Eggs", 6, "Breakfast"));
      console.log(createMenuItem("Soup of the Day", 10, "Lunch"));
...
for(let i =0; i < reviews.length; i++){
  if(reviews[i].name === "Julius"){
    feedbackJulius.push(reviews[i]);
  }
}

console.log(feedbackJulius[0].feedback);
